 ...
 * News Validator
 * 
 * Express-validator rules untuk News validation.
 * 
 * @module validators/newsValidator
 */
...
/**
 * Validator untuk update news (dengan validasi ID parameter)
 */
export const validateUpdateNews = [
  param('id')
    .notEmpty().withMessage('ID berita wajib diisi')
    .isInt({ min: 1 }).withMessage('ID berita harus berupa angka positif'),
  ...validateNews,
];
